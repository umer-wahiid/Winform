...
namespace Shakeel_Brothers
{
    internal class Class1
    {
        ...
        public Class1()
        {
            con = new SqlConnection("Data Source=DESKTOP-R6JGHLF\\MSSQLSERVER01;Integrated Security=true;Initial Catalog=shakeel_brothers");
            //con = new SqlConnection("Data Source=DESKTOP-I6OQBMN;Integrated Security=true;Initial Catalog=shakeel_brother");
